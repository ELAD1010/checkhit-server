export const openApiComponents = {
  ...
  schemas: {
    ...
    Course: {
      ...
      properties: {
        ...
        openAssignmentsCount: {
          ...
          minimum: 0,
          description:
            "Number of unsubmitted published assignments in the course for the requesting student",
        },
        nextDueAt: {
          type: ["string", "null"],
          format: "date-time",
          description:
            "Earliest upcoming due date among unsubmitted assignments",
        },
        createdAt: { type: "string", format: "date-time" },
        updatedAt: { type: "string", format: "date-time" },
      },
    ...
    Submission: {
      type: "object",
      required: ["id", "assignmentId", "studentId", "attemptNumber", "status"],
      properties: {
        id: { type: "string", format: "uuid" },
        assignmentId: { type: "string", format: "uuid" },
    ...
    AppealCourse: {
          ...
          RequiresAttentionItem: {
            ...
            properties: {
              ...
              type: {
                type: "string",
                enum: ["appeal", "ai-grading", "deadline"],
              },
              title: { type: "string" },
          ...
          GradeDistributionData: {
            ...
            properties: {
              ...
              byCourse: {
                type: "array",
                items: {
                  $ref: "#/components/schemas/GradeDistributionCourseData",
                },
              },
            },
          },
          ...
          LecturerDashboardResponse: {
            ...
            properties: {
              ...
              assignmentCompletion: {
                type: "array",
                items: {
                  $ref: "#/components/schemas/AssignmentCompletionItem",
                },
              },
              recentCourses: {
                type: "array",
          ...
          LecturerAssignmentStudentItem: {
            ...
            properties: {
              student: {
                $ref: "#/components/schemas/LecturerAssignmentStudentInfo",
              },
              status: {
                type: "string",
                enum: [
          ...
          LecturerAssignmentOverviewResponse: {
            ...
            properties: {
              ...
              name: {
                type: "string",
                example: "Homework 3: Binary Search Trees",
              },
              description: { type: "string" },
              ...
              updatedAt: { type: "string", format: "date-time" },
              course: {
                $ref: "#/components/schemas/LecturerAssignmentCourseInfo",
              },
